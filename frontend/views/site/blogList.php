...
<div id="fieldtrip-page" class="container">
    <nav class="mt-2 fadeIn animated d07s">
        <ol class="breadcrumb smaller-90 mb-0">
            ...
            <li class="breadcrumb-item"><a href="/site/blog-category"><?= Yii::t('common', 'Blog'); ?></a>
            </li>
            ...
            <div class="col-12 my-2">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-8 col-12 viewpoint-animate d05s" data-animation="fadeIn">
                        ...
                        <a class="smaller-90" href="/site/blog-view?id=<?php echo $blog->id; ?>"><?php echo Yii::t('common', 'read_more');?> <i class="fa fa-angle-right ml-1"></i></a>
                    </div>
                </div>
            </div>
            <?php
