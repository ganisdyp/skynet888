                    ...
                    <div id="image-box" class="col-md-12">
                        ...
                        echo $form->field($model, 'main_photo_file')->widget(FileInput::classname(), [
                            'options' => ['accept' => 'image/*'], 'pluginOptions' => [
                                'showUpload' => false,
                                'initialPreview' => [
                                    ["http://www.safeboxasia.com/backend/uploads/story/$model->main_photo"]
                                ],
            ...
            <div id="photo" class="tab-pane fade in active">
                <div class="row">
                    <?php foreach ($modelDetails as $i => $modelDetail) : ?>
                        <div class="story-profile story-profile-<?= $i ?>" style="margin-top: .75rem;">
                            <div class="col-md-5 col-xs-10">
                                <?= Html::activeHiddenInput($modelDetail, "[$i]id") ?>
                                <?= Html::activeHiddenInput($modelDetail, "[$i]updateType", ['class' => 'update-type']) ?>
                                <?php //echo $form->field($modelDetail, "[$i]story_photo")->fileInput()
                                //
                                echo $form->field($modelDetail, "[$i]story_photo")->widget(FileInput::classname(), [
                                    'options' => ['accept' => 'image/*'], 'pluginOptions' => [
                                        'showUpload' => false,
                                        'initialPreview' => [
                                            ["http://www.safeboxasia.com/backend/uploads/story/related_photo/$modelDetail->photo_url"]
                                        ],
                                        'initialPreviewAsData' => true,
                            ...
                            <div class="col-md-1 col-xs-2">
                                <div style="margin-top: 2rem;">
                                    <?= Html::button('x', ['class' => 'delete-button-photo btn btn-danger', 'data-target' => "story-profile-$i"]) ?>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
