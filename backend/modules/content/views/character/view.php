...
<div class="character-view">
    ...
    $related_photos = $model->getCharacterPhotos()->where(['character_id' => $model->id])->all();

    foreach ($related_photos as $photo) {

        echo Html::img(Yii::$app->getHomeUrl() . 'uploads/character/related_photo/' . $photo->photo_url,
