...
<?php $this->registerJs("
    $('.delete-button-photo').click(function() {
        var detail = $(this).closest('.project-photo');
        var updateType = detail.find('.update-type');
        if (updateType.val() === " . json_encode(ProjectPhoto::UPDATE_TYPE_UPDATE) . ") {
            //marking the row for deletion
            updateType.val(" . json_encode(ProjectPhoto::UPDATE_TYPE_DELETE) . ");
            detail.hide();
        } else {
...
");
?>
    <div class="project-form tab-content">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        ...
                        if ($model->isNewRecord) {
                            ...
                            /*  echo Html::img(Yii::$app->getHomeUrl() . 'uploads/project/' . $model->main_photo,
